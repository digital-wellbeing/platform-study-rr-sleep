...
1. **Subjective sleep quality** (psqi_comp1_quality): Overall self-rating of sleep quality
...
# Individual Regression Model Tables

This section provides detailed output for each individual regression model. Combined summary tables are presented in the main manuscript.
...
# Load modelsummary for regression tables
if (!require("modelsummary")) install.packages("modelsummary")
library(modelsummary)

# Load saved models
model.h1a <- readRDS("output/models/model_h1a.rds")
model.h1b <- readRDS("output/models/model_h1b.rds")
model.h1c <- readRDS("output/models/model_h1c.rds")
model.h1d <- readRDS("output/models/model_h1d.rds")
model.h2a <- readRDS("output/models/model_h2a.rds")
model.h2b <- readRDS("output/models/model_h2b.rds")
model.h2c <- readRDS("output/models/model_h2c.rds")
model.h2d <- readRDS("output/models/model_h2d.rds")
```

## Table S8: H1a - Sleep Quality Model

```{r}
#| label: tbl-h1a
#| tbl-cap: "H1a: Late-night gaming predicting sleep quality (ordinal regression)"
...
## Table S9: H1b - Sleep Duration Model

```{r}
#| label: tbl-h1b
#| tbl-cap: "H1b: Late-night gaming predicting sleep duration (linear mixed model)"
...
## Table S10: H1c - Wellbeing Model

```{r}
#| label: tbl-h1c
#| tbl-cap: "H1c: Late-night gaming predicting wellbeing (linear mixed model)"
...
## Table S11: H1d - Daytime Sleepiness Model

```{r}
#| label: tbl-h1d
#| tbl-cap: "H1d: Late-night gaming predicting daytime sleepiness (linear mixed model)"
...
## Table S12: H2a - Sleep Quality × Chronotype Model

```{r}
#| label: tbl-h2a
#| tbl-cap: "H2a: Late-night gaming × chronotype predicting sleep quality (ordinal regression)"
...
## Table S13: H2b - Sleep Duration × Chronotype Model

```{r}
#| label: tbl-h2b
#| tbl-cap: "H2b: Late-night gaming × chronotype predicting sleep duration (linear mixed model)"
...
## Table S14: H2c - Wellbeing × Chronotype Model

```{r}
#| label: tbl-h2c
#| tbl-cap: "H2c: Late-night gaming × chronotype predicting wellbeing (linear mixed model)"
...
## Table S15: H2d - Daytime Sleepiness × Chronotype Model

```{r}
#| label: tbl-h2d
#| tbl-cap: "H2d: Late-night gaming × chronotype predicting daytime sleepiness (linear mixed model)"
