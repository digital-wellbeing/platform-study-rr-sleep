...
cat("- Panel clean:", nrow(panel_clean), "records\n")
...
# Get ESS (daytime sleepiness) from panel data - use wave 1 or average across waves
ess_data <- panel_clean |>
