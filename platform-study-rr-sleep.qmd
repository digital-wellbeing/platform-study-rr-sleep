...
measures_table <- tibble::tribble(
  ...
  "Sleep Quality", "Pittsburgh Sleep Quality Index (PSQI)", "19 items, 7 components", "0–21", "Higher scores indicate worse sleep quality; >5 indicates poor sleep",
...
descriptive_data <- gamingMonthly |>
  ...
  pivot_longer(
    cols = c(global_psqi, sleep_duration, daytime_sleepiness, wellbeing, chronotype),
    names_to = "variable",
    values_to = "value"
  ) |>
  filter(!is.na(value)) |>
  ...
  mutate(
    variable = factor(variable,
                     levels = c("global_psqi", "sleep_duration", "daytime_sleepiness", "wellbeing", "chronotype"),
...
# Prepare data with ordinal psqi_6
gamingMonthly_h2a <- gamingMonthly |>
  mutate(
    psqi_6_ord = factor(psqi_6,
