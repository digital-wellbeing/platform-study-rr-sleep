...
// Additional Typst variables
  authornote: [Created with Quarto 1.8.27 and #emph[preprint-typst] 1.4.3 on 2026-05-16.
...
Frequentist equivalence tests with a ROPE rescaled to the coefficient's native units (±0.1 × SD(#emph[y];) / SD(#emph[x];); see #ref(<tbl-appendix-equivalence>, supplement: [Table])) supported practical equivalence for the H2b, H2c, and H2d interactions. The H2a interaction was undecided: the 90% CI was narrow but extended marginally beyond the lower bound of the latent-scale ROPE.
...
It is useful to anchor the implied per-hour magnitude against other modifiable lifestyle influences on adult sleep. At roughly 5 percentage points per hour, the sleep-quality cost of late-night gaming appears to be in the same broad range as the perceived sleep-quality cost reported for a high (400 mg) dose of caffeine consumed within four hours of bedtime @gardiner2025dose. This comparison is most directly interpretable for our exploratory diary substudy, which used a structurally similar single-item nightly sleep-quality rating; there, the between-person estimate (0.6 percentage points per 10 min of habitual late-night gaming) aligned closely with the panel PSQI result. A comparable benchmark on the continuous PSQI scale comes from #cite(<yan2024chronobiological>, form: "prose");, who report a ≈0.39-point higher PSQI total score for adults in the latest vs earliest tertile of last-meal time (a ≈3-hour shift). For a contrast of similar practical magnitude in our data --- moving from \~10 min/day to \~3 h/day of late-night gaming --- the panel PSQI sensitivity model implies a ≈1.52-point increase, of comparable order but somewhat smaller, suggesting that the per-person sleep-quality penalty of habitual late-night gaming sits below that of habitually late evening meal timing.
...
<data-code-and-materials-availability>
The parent Open Play dataset @ballou2025openplay, including the Nintendo, Xbox, and Steam telemetry and the intake, biweekly, and daily survey tables used here, is openly released at #link("https://github.com/digital-wellbeing/open-play");. All analytical code for this study is openly released under MIT (code) and CC BY 4.0 (text) at #link("https://github.com/digital-wellbeing/platform-study-rr-sleep");.
...
#block[ // start block
  ...
  #let style-dict = (
    // tinytable style-dict after
    "0_7": 0, "1_7": 0, "2_7": 0, "3_7": 0, "4_7": 0, "0_8": 0, "1_8": 0, "2_8": 0, "3_8": 0, "4_8": 0, "0_9": 0, "1_9": 0, "2_9": 0, "3_9": 0, "4_9": 0
  )
 ...
 table.hline(y: 5, start: 0, end: 10, stroke: 0.1em + black),
