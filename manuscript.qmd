...
#| output: asis
  ...
  coef_map_h2 <- c(
    ...
    "ln_monthly_avg_minutes_played_10:msf_sc_centered" = "LN gaming × Chronotype (monthly)",
    "ln_biweekly_avg_minutes_played_10:msf_sc_centered" = "LN gaming × Chronotype (biweekly)",
    "age_scaled" = "Age (scaled)",
    "bmi_scaled" = "BMI (scaled)",
    "SES_index_scaled" = "SES (scaled)",
    "regionUS" = "Region: US",
...
#| tbl-cap: "Diary CLM Regression Results: H1 (Direct Effects) and H2 (Chronotype Moderation) for Sleep Quality"
#| echo: false
#| message: false
#| warning: false
