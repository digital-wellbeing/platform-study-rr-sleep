...
if (!is.null(diary_model_h1_loaded) && !is.null(diary_model_h2_loaded)) {
  ...
  modelsummary(
    ...
    notes = c(
      ...
      "LN = late-night. Confidence intervals shown in brackets.",
      "Cumulative link mixed models (random intercept for participant) on 5-level ordinal sleep quality (positive coefficients = higher probability of worse sleep). Both H1 and H2 use probit link (logit did not converge reliably for either model). Late-night gaming expressed per 10 minutes; chronotype in centered hours; age, BMI, SES scaled within the diary subsample; region (UK/US) included for consistency with panel models.",
